...
@if($u)
    <div class="relative" id="farmerNotificationMenuWrap">
        <button type="button" id="farmerNotificationMenuBtn"
        ...
        <div id="farmerNotificationMenu"
            ...
            <div class="max-h-80 overflow-y-auto">
                @forelse($unreadNotifications ?? [] as $notification)
                    <form method="POST" action="{{ route('farmer.notifications.read', $notification->id) }}">
                        @csrf
                        <button type="submit"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const btn = document.getElementById('farmerNotificationMenuBtn');
        const menu = document.getElementById('farmerNotificationMenu');
        ...
        document.addEventListener('click', function (event) {
            const wrap = document.getElementById('farmerNotificationMenuWrap');
