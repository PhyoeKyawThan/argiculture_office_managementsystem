            ...
            <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
                ...
                <div class="p-4 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col justify-between space-y-3">
                    ...
                    @if($pesticideShop->surrounding_agreement_attachment)
                        <div id="preview-surrounding_agreement_attachment" class="border border-slate-200 rounded-xl overflow-hidden bg-white max-h-32 flex items-center justify-between p-2">
                            <img src="{{ asset('storage/' . $pesticideShop->surrounding_agreement_attachment) }}" alt="Preview" class="max-h-28 w-auto object-contain rounded-lg">
...
@section('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const existingItems = @json(old('items', $pesticideShop->items ?? []));
            ...
            if (existingItems && existingItems.length > 0) {
                existingItems.forEach(item => {
                    addItemRow(item.name || '', item.formula || '', item.type || '', item.capacity || '');
                });
            } else {
                addItemRow();
            }
