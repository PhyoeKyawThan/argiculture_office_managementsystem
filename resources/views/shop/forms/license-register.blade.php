...
@section('content')
    <div class="w-[100%] max-w-4xl mx-auto py-8 px-4">
        ...
        <p class="text-sm text-slate-500 mb-6">လျှောက်လွှာတင်ရန်အောက်ပါအချက်အလက်များကိုဖြည့်စွက်ပါ။</p>
        ...
        <form id="license-form" action="{{ route('shop.storeLicenseApplication') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            ...
            <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        <label for="name" class="block text-sm font-bold text-slate-700 mb-1">လျှောက်ထားသူအမည်</label>
                    ...
                    <div>
                        <label for="township" class="block text-sm font-bold text-slate-700 mb-1">မြို့နယ်</label>
                ...
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-1">နိုင်ငံသားစိစစ်ရေးကတ်ပြားအမှတ်</label>
                    <div class="flex flex-wrap gap-2 items-center">
                        ...
                        <input type="text" id="nrc_number" placeholder="၁၂၃၄၅၆" value="{{ old('nrc_serial_val') }}" maxlength="6" required class="flex-1 min-w-[150px] rounded-xl border border-slate-200 px-4 py-2.5 focus:ring-2 focus:ring-emerald-500 outline-none">
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        <label for="education" class="block text-sm font-bold text-slate-700 mb-1">ပညာအရည်အချင်း</label>
                    ...
                    <div>
                        <label for="stable_address" class="block text-sm font-bold text-slate-700 mb-1">အမြဲတမ်းနေရပ်လိပ်စာ</label>
            ...
            <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
                ...
                <div>
                    <label for="requested_selling_address" class="block text-sm font-bold text-slate-700 mb-1">ပိုးသတ်ဆေးသိုလှောင်မည့်/ရောင်းချမည့်နေရာ</label>
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        <label for="building_type" class="block text-sm font-bold text-slate-700 mb-1">အဆောက်အအုံအမျိုးအစား</label>
                    ...
                    <div>
                        <label for="building_area" class="block text-sm font-bold text-slate-700 mb-1">အကျယ်အဝန်း</label>
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        <label for="from_restaurant_distance" class="block text-sm font-bold text-slate-700 mb-1">စားသောက်ဆိုင်နှင့်ဆေးဆိုင်များမှအကွာအဝေးဖော်ပြချက်</label>
                    ...
                    <div>
                        <label for="retail_or_wholesale" class="block text-sm font-bold text-slate-700 mb-1">လုပ်ငန်းအမျိုးအစား</label>
                        <select name="retail_or_wholesale" id="retail_or_wholesale" required class="w-full rounded-xl border border-slate-200 px-4 py-2.5 bg-white focus:ring-2 focus:ring-emerald-500 outline-none">
                            <option value="retail" {{ old('retail_or_wholesale') === 'retail' ? 'selected' : '' }}>လက်လီ</option>
                            <option value="wholesale" {{ old('retail_or_wholesale') === 'wholesale' ? 'selected' : '' }}>လက်ကား</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="flex items-start bg-slate-50 p-4 rounded-2xl border border-slate-100">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="has_emergency_preparedness_plan" class="font-bold text-slate-800"></label>
            ...
            <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    @foreach([
                        ...
                        'card_back' => 'သင်တန်းဆင်းကတ်ပြား - အနောက်ဖက်',
            ...
            <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-3">
                <h3 class="text-base font-black text-emerald-800 border-l-4 border-emerald-600 pl-2">၅။ လျှောက်ထားသူ၏ လက်မှတ် </h3>
                <div class="max-w-xs">
