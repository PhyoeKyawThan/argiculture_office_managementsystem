...
class LicenseStatusUpdatedNotification extends Notification
{
    ...
    public function toArray(object $notifiable): array
    {
        ...
        $message = match ($this->license->status) {
            ...
            FertilizerDistributionLicense::STATUS_CANCELLED => 'Your fertilizer distribution license application was cancelled because the submitted details did not match the required information. Please review and resubmit with corrected information.',
